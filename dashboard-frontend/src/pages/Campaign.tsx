...
const Campaign = () => {
  ...
  return (
    <>
      <Breadcrumb pageName="Phishing Campaigns" />
      ...
      <div className="border-b border-stroke px-7 py-4 dark:border-strokedark">
        ...
        {isCampaignSaved && (
          <div className="flex w-full border-l-6 border-[#34D399] bg-[#34D399] bg-opacity-[15%] px-7 py-8 mt-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
